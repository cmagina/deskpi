...
sudo rm -f /usr/local/bin/fanStop 2&>/dev/null
sudo rm -f /usr/local/bin/pwmFanControl 2&>/dev/null 
sudo rm -f /usr/local/bin/deskpi-config 2&>/dev/null 
sudo rm -f /usr/local/bin/Deskpi-uninstall 2&>/dev/null 
